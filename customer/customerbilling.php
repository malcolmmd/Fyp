...
?>
    ...
    <table>
      <tr>
        <td align="center"> 
        <img src="<?php echo web_root; ?>images/bg23.jpg"  height="90px" style="-webkit-border-radius:5px; -moz-border-radius:5px;" alt="Image">
            </td>
 ...
 <h4><strong>Order Information</strong></h4>
        ...
        <?php
          ...
          $query = "SELECT * 
            ...
            foreach ($cur as $result) {
              ...
              echo '<td> RM '. number_format($result->PROPRICE,2).' </td>';
              echo '<td align="center" >'. $result->ORDEREDQTY.'</td>';
              ?>
               <td> RM <output><?php echo  number_format($result->ORDEREDPRICE,2); ?></output></td> 
              <?php
    ...
    <div class="row">
        ...
        <div class="col-md-6 pull-right">
          <p align="right">Total Price : RM <?php echo number_format($tot,2);?></p>
          <p align="right">Delivery Fee : RM <?php echo number_format($price,2); ?></p>
          <p align="right">Overall Price : RM <?php echo number_format($cur->PAYMENT,2); ?></p>
        </div>
      </div>
