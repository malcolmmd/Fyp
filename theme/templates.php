          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills">
                <li><a href="#"><i class="fa fa-phone"></i> +65 9671 0219 </a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> hv@happyvines.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/newlogo.jpg" alt="" /></a>
            </div> 
          </div>
          ...
          <div class="col-sm-9">
            ...
            <div class="mainmenu pull-left">
              <ul class="nav navbar-nav collapse navbar-collapse">
                ...
                <li><a href="<?php web_root?>index.php?q=reservation">Reservation</a></li>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Happy</span>Vines</h2>
              <p>First internet wines merchant serving Malaysia Singapore India Asia Dishes</p>
            </div>
          </div>
          <div class="col-sm-7">
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                    <iframe class="iframe-img"  src="https://www.youtube.com/embed/J1aHM5-HfgY"   allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                </a> 
              </div>
            </div>
            ...
            <div class="col-sm-6">
              <div class="video-gallery text-center">
                <a href="#"> 
                   <iframe  class="iframe-img"  src="https://www.youtube.com/embed/qYN1M9oc8-w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
                </a> 
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>706 Clementi West St 2, #04-385, SINGAPORE 120706</p>
            </div>
          </div>
        </div>
      </div>
